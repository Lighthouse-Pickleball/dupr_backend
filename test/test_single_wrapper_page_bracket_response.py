...
class TestSingleWrapperPageBracketResponse(unittest.TestCase):
    """SingleWrapperPageBracketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageBracketResponse:
        """Test SingleWrapperPageBracketResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageBracketResponse`
        """
        model = SingleWrapperPageBracketResponse()
        if include_optional:
            return SingleWrapperPageBracketResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_bracket_response.PageBracketResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageBracketResponse(self):
        """Test SingleWrapperPageBracketResponse"""
