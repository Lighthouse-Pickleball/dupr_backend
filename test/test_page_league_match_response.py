...
class TestPageLeagueMatchResponse(unittest.TestCase):
    """PageLeagueMatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageLeagueMatchResponse:
        """Test PageLeagueMatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageLeagueMatchResponse`
        """
        model = PageLeagueMatchResponse()
        if include_optional:
            return PageLeagueMatchResponse(
                offset = 90,
                limit = 10,
                total = 100,
                hits = [
    ...
    def testPageLeagueMatchResponse(self):
        """Test PageLeagueMatchResponse"""
