...
class TestPageLeagueStandingResponse(unittest.TestCase):
    """PageLeagueStandingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageLeagueStandingResponse:
        """Test PageLeagueStandingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageLeagueStandingResponse`
        """
        model = PageLeagueStandingResponse()
        if include_optional:
            return PageLeagueStandingResponse(
                offset = 90,
                limit = 10,
                total = 100,
                hits = [
    ...
    def testPageLeagueStandingResponse(self):
        """Test PageLeagueStandingResponse"""
