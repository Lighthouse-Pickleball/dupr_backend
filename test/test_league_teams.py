...
class TestLeagueTeams(unittest.TestCase):
    """LeagueTeams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeagueTeams:
        """Test LeagueTeams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeagueTeams`
        """
        model = LeagueTeams()
        if include_optional:
            return LeagueTeams(
