...
class TestSingleWrapperPagePlayerPaymentResponse(unittest.TestCase):
    """SingleWrapperPagePlayerPaymentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPagePlayerPaymentResponse:
        """Test SingleWrapperPagePlayerPaymentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPagePlayerPaymentResponse`
        """
        model = SingleWrapperPagePlayerPaymentResponse()
        if include_optional:
            return SingleWrapperPagePlayerPaymentResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_player_payment_response.PagePlayerPaymentResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPagePlayerPaymentResponse(self):
        """Test SingleWrapperPagePlayerPaymentResponse"""
