...
class TestSingleWrapperBracketResponse(unittest.TestCase):
    """SingleWrapperBracketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperBracketResponse:
        """Test SingleWrapperBracketResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperBracketResponse`
        """
        model = SingleWrapperBracketResponse()
        if include_optional:
    ...
    def testSingleWrapperBracketResponse(self):
        """Test SingleWrapperBracketResponse"""
