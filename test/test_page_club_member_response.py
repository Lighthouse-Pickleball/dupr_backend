...
class TestPageClubMemberResponse(unittest.TestCase):
    """PageClubMemberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageClubMemberResponse:
        """Test PageClubMemberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageClubMemberResponse`
        """
        model = PageClubMemberResponse()
        if include_optional:
            return PageClubMemberResponse(
                offset = 90,
                limit = 10,
                total = 100,
                hits = [
    ...
    def testPageClubMemberResponse(self):
        """Test PageClubMemberResponse"""
