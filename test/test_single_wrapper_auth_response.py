...
class TestSingleWrapperAuthResponse(unittest.TestCase):
    """SingleWrapperAuthResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperAuthResponse:
        """Test SingleWrapperAuthResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperAuthResponse`
        """
        model = SingleWrapperAuthResponse()
        if include_optional:
            return SingleWrapperAuthResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.auth_response.AuthResponse(
    ...
    def testSingleWrapperAuthResponse(self):
        """Test SingleWrapperAuthResponse"""
