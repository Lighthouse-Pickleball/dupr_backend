...
class TestSingleWrapperUserResponse(unittest.TestCase):
    """SingleWrapperUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperUserResponse:
        """Test SingleWrapperUserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperUserResponse`
        """
        model = SingleWrapperUserResponse()
        if include_optional:
            return SingleWrapperUserResponse(
                status = 'SUCCESS',
    ...
    def testSingleWrapperUserResponse(self):
        """Test SingleWrapperUserResponse"""
