...
class TestSingleWrapperPagePlayerResponse(unittest.TestCase):
    """SingleWrapperPagePlayerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPagePlayerResponse:
        """Test SingleWrapperPagePlayerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPagePlayerResponse`
        """
        model = SingleWrapperPagePlayerResponse()
        if include_optional:
            return SingleWrapperPagePlayerResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_player_response.PagePlayerResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPagePlayerResponse(self):
        """Test SingleWrapperPagePlayerResponse"""
