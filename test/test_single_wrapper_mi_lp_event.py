...
class TestSingleWrapperMiLPEvent(unittest.TestCase):
    """SingleWrapperMiLPEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperMiLPEvent:
        """Test SingleWrapperMiLPEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperMiLPEvent`
        """
        model = SingleWrapperMiLPEvent()
        if include_optional:
            return SingleWrapperMiLPEvent(
                status = 'SUCCESS',
    ...
    def testSingleWrapperMiLPEvent(self):
        """Test SingleWrapperMiLPEvent"""
