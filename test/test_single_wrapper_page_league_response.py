...
class TestSingleWrapperPageLeagueResponse(unittest.TestCase):
    """SingleWrapperPageLeagueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageLeagueResponse:
        """Test SingleWrapperPageLeagueResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageLeagueResponse`
        """
        model = SingleWrapperPageLeagueResponse()
        if include_optional:
            return SingleWrapperPageLeagueResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_league_response.PageLeagueResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageLeagueResponse(self):
        """Test SingleWrapperPageLeagueResponse"""
