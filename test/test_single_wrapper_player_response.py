...
class TestSingleWrapperPlayerResponse(unittest.TestCase):
    """SingleWrapperPlayerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPlayerResponse:
        """Test SingleWrapperPlayerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPlayerResponse`
        """
        model = SingleWrapperPlayerResponse()
        if include_optional:
            return SingleWrapperPlayerResponse(
                status = 'SUCCESS',
    ...
    def testSingleWrapperPlayerResponse(self):
        """Test SingleWrapperPlayerResponse"""
