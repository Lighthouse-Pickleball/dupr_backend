...
class TestArrayWrapperPostResponse(unittest.TestCase):
    """ArrayWrapperPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayWrapperPostResponse:
        """Test ArrayWrapperPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayWrapperPostResponse`
        """
        model = ArrayWrapperPostResponse()
        if include_optional:
            return ArrayWrapperPostResponse(
                status = 'SUCCESS',
    ...
    def testArrayWrapperPostResponse(self):
        """Test ArrayWrapperPostResponse"""
