...
class TestPageMatchResponse(unittest.TestCase):
    """PageMatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageMatchResponse:
        """Test PageMatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageMatchResponse`
        """
        model = PageMatchResponse()
        if include_optional:
    ...
    def testPageMatchResponse(self):
        """Test PageMatchResponse"""
