...
class TestArrayWrapperMatchRound(unittest.TestCase):
    """ArrayWrapperMatchRound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayWrapperMatchRound:
        """Test ArrayWrapperMatchRound
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayWrapperMatchRound`
        """
        model = ArrayWrapperMatchRound()
        if include_optional:
            return ArrayWrapperMatchRound(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                results = [
                    dupr_backend.models.match_round.MatchRound(
                        serial = 1, 
                        matches = [
    ...
    def testArrayWrapperMatchRound(self):
        """Test ArrayWrapperMatchRound"""
