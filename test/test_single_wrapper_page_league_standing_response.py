...
class TestSingleWrapperPageLeagueStandingResponse(unittest.TestCase):
    """SingleWrapperPageLeagueStandingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageLeagueStandingResponse:
        """Test SingleWrapperPageLeagueStandingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageLeagueStandingResponse`
        """
        model = SingleWrapperPageLeagueStandingResponse()
        if include_optional:
            return SingleWrapperPageLeagueStandingResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_league_standing_response.PageLeagueStandingResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageLeagueStandingResponse(self):
        """Test SingleWrapperPageLeagueStandingResponse"""
