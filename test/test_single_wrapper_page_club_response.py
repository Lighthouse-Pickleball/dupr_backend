...
class TestSingleWrapperPageClubResponse(unittest.TestCase):
    """SingleWrapperPageClubResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageClubResponse:
        """Test SingleWrapperPageClubResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageClubResponse`
        """
        model = SingleWrapperPageClubResponse()
        if include_optional:
            return SingleWrapperPageClubResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_club_response.PageClubResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageClubResponse(self):
        """Test SingleWrapperPageClubResponse"""
