...
class TestArrayWrapperPostReactionResponse(unittest.TestCase):
    """ArrayWrapperPostReactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayWrapperPostReactionResponse:
        """Test ArrayWrapperPostReactionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayWrapperPostReactionResponse`
        """
        model = ArrayWrapperPostReactionResponse()
        if include_optional:
            return ArrayWrapperPostReactionResponse(
                status = 'SUCCESS',
    ...
    def testArrayWrapperPostReactionResponse(self):
        """Test ArrayWrapperPostReactionResponse"""
