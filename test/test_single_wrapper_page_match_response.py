...
class TestSingleWrapperPageMatchResponse(unittest.TestCase):
    """SingleWrapperPageMatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageMatchResponse:
        """Test SingleWrapperPageMatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageMatchResponse`
        """
        model = SingleWrapperPageMatchResponse()
        if include_optional:
            return SingleWrapperPageMatchResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_match_response.PageMatchResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageMatchResponse(self):
        """Test SingleWrapperPageMatchResponse"""
