...
class TestSingleWrapperPageLeagueTeamsResponse(unittest.TestCase):
    """SingleWrapperPageLeagueTeamsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageLeagueTeamsResponse:
        """Test SingleWrapperPageLeagueTeamsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageLeagueTeamsResponse`
        """
        model = SingleWrapperPageLeagueTeamsResponse()
        if include_optional:
            return SingleWrapperPageLeagueTeamsResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_league_teams_response.PageLeagueTeamsResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageLeagueTeamsResponse(self):
        """Test SingleWrapperPageLeagueTeamsResponse"""
