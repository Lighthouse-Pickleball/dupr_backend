...
import dupr_backend
from dupr_backend.models.single_wrapper_of_page_of_club_response import SingleWrapperOfPageOfClubResponse  # noqa: E501
from dupr_backend.rest import ApiException

class TestSingleWrapperOfPageOfClubResponse(unittest.TestCase):
    """SingleWrapperOfPageOfClubResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SingleWrapperOfPageOfClubResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperOfPageOfClubResponse`
        """
        model = dupr_backend.models.single_wrapper_of_page_of_club_response.SingleWrapperOfPageOfClubResponse()  # noqa: E501
        if include_optional :
            return SingleWrapperOfPageOfClubResponse(
                message = 'Show this message to user.', 
                result = dupr_backend.models.page_of_club_response.PageOfClubResponse(
                    empty = False, 
                    has_more = False, 
                    has_previous = True, 
                    hits = [
    ...
    def testSingleWrapperOfPageOfClubResponse(self):
        """Test SingleWrapperOfPageOfClubResponse"""
