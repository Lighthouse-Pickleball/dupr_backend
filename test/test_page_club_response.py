...
class TestPageClubResponse(unittest.TestCase):
    """PageClubResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageClubResponse:
        """Test PageClubResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageClubResponse`
        """
        model = PageClubResponse()
        if include_optional:
