...
class TestPageUserLookupResponse(unittest.TestCase):
    """PageUserLookupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageUserLookupResponse:
        """Test PageUserLookupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageUserLookupResponse`
        """
        model = PageUserLookupResponse()
        if include_optional:
            return PageUserLookupResponse(
                offset = 90,
                limit = 10,
                total = 100,
                hits = [
    ...
    def testPageUserLookupResponse(self):
        """Test PageUserLookupResponse"""
