...
import dupr_backend
from dupr_backend.models.player_res import PlayerRes  # noqa: E501
from dupr_backend.rest import ApiException

class TestPlayerRes(unittest.TestCase):
    """PlayerRes unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `PlayerRes`
        """
        model = dupr_backend.models.player_res.PlayerRes()  # noqa: E501
        if include_optional :
            return PlayerRes(
                age = 56, 
                birthdate = '', 
