...
class TestSingleWrapperPostResponse(unittest.TestCase):
    """SingleWrapperPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPostResponse:
        """Test SingleWrapperPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPostResponse`
        """
        model = SingleWrapperPostResponse()
        if include_optional:
            return SingleWrapperPostResponse(
                status = 'SUCCESS',
    ...
    def testSingleWrapperPostResponse(self):
        """Test SingleWrapperPostResponse"""
