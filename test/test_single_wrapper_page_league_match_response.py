...
class TestSingleWrapperPageLeagueMatchResponse(unittest.TestCase):
    """SingleWrapperPageLeagueMatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageLeagueMatchResponse:
        """Test SingleWrapperPageLeagueMatchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageLeagueMatchResponse`
        """
        model = SingleWrapperPageLeagueMatchResponse()
        if include_optional:
            return SingleWrapperPageLeagueMatchResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_league_match_response.PageLeagueMatchResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageLeagueMatchResponse(self):
        """Test SingleWrapperPageLeagueMatchResponse"""
