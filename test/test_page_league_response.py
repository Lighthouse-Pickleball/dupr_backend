...
class TestPageLeagueResponse(unittest.TestCase):
    """PageLeagueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageLeagueResponse:
        """Test PageLeagueResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageLeagueResponse`
        """
        model = PageLeagueResponse()
        if include_optional:
            return PageLeagueResponse(
                offset = 90,
                limit = 10,
                total = 100,
                hits = [
    ...
    def testPageLeagueResponse(self):
        """Test PageLeagueResponse"""
