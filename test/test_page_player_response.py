...
class TestPagePlayerResponse(unittest.TestCase):
    """PagePlayerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagePlayerResponse:
        """Test PagePlayerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagePlayerResponse`
        """
        model = PagePlayerResponse()
        if include_optional:
            return PagePlayerResponse(
                offset = 90,
                limit = 10,
                total = 100,
                hits = [
    ...
    def testPagePlayerResponse(self):
        """Test PagePlayerResponse"""
