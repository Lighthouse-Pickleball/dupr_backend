...
class TestSingleWrapperPageUnclaimedPlayerResponse(unittest.TestCase):
    """SingleWrapperPageUnclaimedPlayerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWrapperPageUnclaimedPlayerResponse:
        """Test SingleWrapperPageUnclaimedPlayerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWrapperPageUnclaimedPlayerResponse`
        """
        model = SingleWrapperPageUnclaimedPlayerResponse()
        if include_optional:
            return SingleWrapperPageUnclaimedPlayerResponse(
                status = 'SUCCESS',
                message = 'Show this message to user.',
                result = dupr_backend.models.page_unclaimed_player_response.PageUnclaimedPlayerResponse(
                    offset = 90, 
                    limit = 10, 
                    total = 100, 
                    hits = [
    ...
    def testSingleWrapperPageUnclaimedPlayerResponse(self):
        """Test SingleWrapperPageUnclaimedPlayerResponse"""
