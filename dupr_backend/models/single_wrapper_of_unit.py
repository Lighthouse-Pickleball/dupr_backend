...
class SingleWrapperOfUnit(BaseModel):
    """
    SingleWrapperOfUnit
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfUnit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfUnit:
        """Create an instance of SingleWrapperOfUnit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfUnit.parse_obj(obj)

        _obj = SingleWrapperOfUnit.parse_obj({
