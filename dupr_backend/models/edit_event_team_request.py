...
class EditEventTeamRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clubId", "bracketId", "registrationId", "player1", "player2", "isPlayer1ClubMember", "isPlayer2ClubMember"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isPlayer1ClubMember": obj.get("isPlayer1ClubMember"),
            "isPlayer2ClubMember": obj.get("isPlayer2ClubMember")
        })
        return _obj
