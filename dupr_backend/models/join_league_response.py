...
class JoinLeagueResponse(BaseModel):
    ...
    JoinLeagueResponse
    """ # noqa: E501
    success: List[StrictInt]
    failed: List[StrictInt]
    session: Optional[SessionResponse] = None
    __properties: ClassVar[List[str]] = ["success", "failed", "session"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "session": SessionResponse.from_dict(obj["session"]) if obj.get("session") is not None else None
        })
        return _obj
