...
class PageOfLeagueTeamsResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(LeagueTeamsResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfLeagueTeamsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfLeagueTeamsResponse:
        """Create an instance of PageOfLeagueTeamsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfLeagueTeamsResponse.parse_obj(obj)

        _obj = PageOfLeagueTeamsResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [LeagueTeamsResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
