...
class PageOfUnclaimedPlayerResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(UnclaimedPlayerResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfUnclaimedPlayerResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfUnclaimedPlayerResponse:
        """Create an instance of PageOfUnclaimedPlayerResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfUnclaimedPlayerResponse.parse_obj(obj)

        _obj = PageOfUnclaimedPlayerResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [UnclaimedPlayerResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
