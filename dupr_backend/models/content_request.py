...
class ContentRequest(BaseModel):
    ...
    footer: StrictStr = Field(...)
    footer_type: StrictStr = Field(..., alias="footerType")
    header: StrictStr = Field(...)
    header_type: StrictStr = Field(..., alias="headerType")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContentRequest:
        """Create an instance of ContentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContentRequest.parse_obj(obj)

        _obj = ContentRequest.parse_obj({
