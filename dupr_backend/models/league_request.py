...
class LeagueRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clubId", "userId", "leagueName", "mediaId", "liabilityWaiverId", "memberFee", "nonMemberFee", "longDescription", "shortDescription", "additionalInformation", "refundPolicy", "safetyPolicy", "addressId", "type", "attributes", "membershipPermission", "advertiseStart", "advertiseEnd", "brackets", "leagueId", "status", "registrationUrl", "startDate", "endDate"]
