...
class OpenPlayEvent(BaseModel):
    ...
    time: TimeRangeRes
    __properties: ClassVar[List[str]] = ["creator", "date", "description", "id", "location", "maxPlayers", "name", "rating", "registeredPlayers", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "rating": RatingRangeRes.from_dict(obj["rating"]) if obj.get("rating") is not None else None,
            "registeredPlayers": obj.get("registeredPlayers"),
            "time": TimeRangeRes.from_dict(obj["time"]) if obj.get("time") is not None else None
        })
        return _obj
