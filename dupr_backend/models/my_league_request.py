...
class MyLeagueRequest(BaseModel):
    ...
    __properties = ["limit", "offset", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MyLeagueRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MyLeagueRequest:
        """Create an instance of MyLeagueRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MyLeagueRequest.parse_obj(obj)

        _obj = MyLeagueRequest.parse_obj({
            "limit": obj.get("limit"),
