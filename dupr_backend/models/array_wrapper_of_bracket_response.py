...
class ArrayWrapperOfBracketResponse(BaseModel):
    """
    ArrayWrapperOfBracketResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(BracketResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfBracketResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfBracketResponse:
        """Create an instance of ArrayWrapperOfBracketResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfBracketResponse.parse_obj(obj)

        _obj = ArrayWrapperOfBracketResponse.parse_obj({
            "message": obj.get("message"),
            "results": [BracketResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
