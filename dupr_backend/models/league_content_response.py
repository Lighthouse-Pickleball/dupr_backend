...
class LeagueContentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeagueContentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeagueContentResponse:
        """Create an instance of LeagueContentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeagueContentResponse.parse_obj(obj)

        _obj = LeagueContentResponse.parse_obj({
