...
class LeagueContentResponse(BaseModel):
    """
    LeagueContentResponse
    """ # noqa: E501
    content_id: StrictInt = Field(alias="contentId")
    header: Optional[StrictStr] = None
    header_type: Optional[StrictStr] = Field(default=None, alias="headerType")
    content: StrictStr
    content_type: StrictStr = Field(alias="contentType")
    footer: Optional[StrictStr] = None
    footer_type: Optional[StrictStr] = Field(default=None, alias="footerType")
    __properties: ClassVar[List[str]] = ["contentId", "header", "headerType", "content", "contentType", "footer", "footerType"]
