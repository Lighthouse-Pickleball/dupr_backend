...
class PageOfUserSubscription(BaseModel):
    """
    ...
    hits: Optional[conlist(UserSubscription)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfUserSubscription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfUserSubscription:
        """Create an instance of PageOfUserSubscription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfUserSubscription.parse_obj(obj)

        _obj = PageOfUserSubscription.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [UserSubscription.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
