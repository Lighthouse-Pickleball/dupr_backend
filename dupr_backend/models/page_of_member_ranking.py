...
class PageOfMemberRanking(BaseModel):
    """
    PageOfMemberRanking
    """
    ...
    hits: Optional[conlist(MemberRanking)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfMemberRanking:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfMemberRanking:
        """Create an instance of PageOfMemberRanking from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfMemberRanking.parse_obj(obj)

        _obj = PageOfMemberRanking.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [MemberRanking.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
