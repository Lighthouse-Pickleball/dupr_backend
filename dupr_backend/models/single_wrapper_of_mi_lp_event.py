...
class SingleWrapperOfMiLPEvent(BaseModel):
    """
    SingleWrapperOfMiLPEvent
    """
    message: Optional[StrictStr] = None
    result: Optional[MiLPEvent] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfMiLPEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfMiLPEvent:
        """Create an instance of SingleWrapperOfMiLPEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfMiLPEvent.parse_obj(obj)

        _obj = SingleWrapperOfMiLPEvent.parse_obj({
            "message": obj.get("message"),
            "result": MiLPEvent.from_dict(obj.get("result")) if obj.get("result") is not None else None,
