...
class VerifyOtpRequest(BaseModel):
    ...
    VerifyOtpRequest
    """ # noqa: E501
    iso_code: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="isoCode")
    phone_number: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="phoneNumber")
    otp: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["isoCode", "phoneNumber", "otp"]
