...
class ArrayWrapperOfLeagueMatchResponse(BaseModel):
    """
    ArrayWrapperOfLeagueMatchResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(LeagueMatchResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfLeagueMatchResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfLeagueMatchResponse:
        """Create an instance of ArrayWrapperOfLeagueMatchResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfLeagueMatchResponse.parse_obj(obj)

        _obj = ArrayWrapperOfLeagueMatchResponse.parse_obj({
            "message": obj.get("message"),
            "results": [LeagueMatchResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
