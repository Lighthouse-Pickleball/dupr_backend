...
class SearchUnmatchedPlayersRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bracketId", "limit", "offset", "query", "sort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": obj.get("query"),
            "sort": BracketUnmatchedPlayerSort.from_dict(obj["sort"]) if obj.get("sort") is not None else None
        })
        return _obj
