...
class BasicUserInfo(BaseModel):
    ...
    __properties = ["email", "id", "name", "referralCode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BasicUserInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BasicUserInfo:
        """Create an instance of BasicUserInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BasicUserInfo.parse_obj(obj)

        _obj = BasicUserInfo.parse_obj({
            "email": obj.get("email"),
            "id": obj.get("id"),
            "name": obj.get("name"),
