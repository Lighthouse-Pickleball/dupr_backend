...
class SingleWrapperOfobject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfobject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfobject:
        """Create an instance of SingleWrapperOfobject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfobject.parse_obj(obj)

        _obj = SingleWrapperOfobject.parse_obj({
