...
class SendOtpRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendOtpRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendOtpRequest:
        """Create an instance of SendOtpRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendOtpRequest.parse_obj(obj)

        _obj = SendOtpRequest.parse_obj({
