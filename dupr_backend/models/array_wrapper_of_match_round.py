...
class ArrayWrapperOfMatchRound(BaseModel):
    """
    ArrayWrapperOfMatchRound
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(MatchRoundRes)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfMatchRound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfMatchRound:
        """Create an instance of ArrayWrapperOfMatchRound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfMatchRound.parse_obj(obj)

        _obj = ArrayWrapperOfMatchRound.parse_obj({
            "message": obj.get("message"),
            "results": [MatchRoundRes.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
