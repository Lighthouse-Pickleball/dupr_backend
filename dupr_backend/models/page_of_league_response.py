...
class PageOfLeagueResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(LeagueResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfLeagueResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfLeagueResponse:
        """Create an instance of PageOfLeagueResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfLeagueResponse.parse_obj(obj)

        _obj = PageOfLeagueResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [LeagueResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
