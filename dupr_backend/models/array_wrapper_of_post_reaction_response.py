...
class ArrayWrapperOfPostReactionResponse(BaseModel):
    """
    ArrayWrapperOfPostReactionResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(PostReactionResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfPostReactionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfPostReactionResponse:
        """Create an instance of ArrayWrapperOfPostReactionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfPostReactionResponse.parse_obj(obj)

        _obj = ArrayWrapperOfPostReactionResponse.parse_obj({
            "message": obj.get("message"),
            "results": [PostReactionResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
