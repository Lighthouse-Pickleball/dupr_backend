...
class PageOfMiLPEvent(BaseModel):
    """
    PageOfMiLPEvent
    """
    ...
    hits: Optional[conlist(MiLPEvent)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfMiLPEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfMiLPEvent:
        """Create an instance of PageOfMiLPEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfMiLPEvent.parse_obj(obj)

        _obj = PageOfMiLPEvent.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [MiLPEvent.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
