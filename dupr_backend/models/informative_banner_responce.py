...
class InformativeBannerResponce(BaseModel):
    ...
    """ # noqa: E501
    banner_id: Optional[StrictInt] = Field(default=None, alias="bannerId")
    ...
    __properties: ClassVar[List[str]] = ["bannerId", "description", "endDateTime", "startDateTime", "status", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "description": BannerContentResponce.from_dict(obj["description"]) if obj.get("description") is not None else None,
