...
class CreateStripeSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    client_key: StrictStr = Field(alias="clientKey")
    return_url: StrictStr = Field(alias="returnUrl")
    success_url: Optional[StrictStr] = Field(default=None, alias="successUrl")
    canceled_url: Optional[StrictStr] = Field(default=None, alias="canceledUrl")
    __properties: ClassVar[List[str]] = ["clientKey", "returnUrl", "successUrl", "canceledUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canceledUrl": obj.get("canceledUrl")
        })
        return _obj
