...
class PlayerSort(BaseModel):
    ...
    def parameter_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RATINGS', 'SINGLES_RATINGS', 'DOUBLES_RATINGS', 'PLAYER_NAME']):
            raise ValueError("must be one of enum values ('RATINGS', 'SINGLES_RATINGS', 'DOUBLES_RATINGS', 'PLAYER_NAME')")
        return value
