...
class RatingOverviewResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["all", "doubles", "singles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "all": OverviewResponse.from_dict(obj["all"]) if obj.get("all") is not None else None,
            "doubles": OverviewResponse.from_dict(obj["doubles"]) if obj.get("doubles") is not None else None,
            "singles": OverviewResponse.from_dict(obj["singles"]) if obj.get("singles") is not None else None
        })
        return _obj
