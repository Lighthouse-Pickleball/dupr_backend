...
class ArrayWrapperOfActivityUser(BaseModel):
    """
    ArrayWrapperOfActivityUser
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(ActivityUser)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfActivityUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfActivityUser:
        """Create an instance of ArrayWrapperOfActivityUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfActivityUser.parse_obj(obj)

        _obj = ArrayWrapperOfActivityUser.parse_obj({
            "message": obj.get("message"),
            "results": [ActivityUser.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
