...
class ShareMatchRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShareMatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShareMatchRequest:
        """Create an instance of ShareMatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShareMatchRequest.parse_obj(obj)

        _obj = ShareMatchRequest.parse_obj({
