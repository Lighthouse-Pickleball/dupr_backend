...
class MergeUsersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MergeUsersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MergeUsersResponse:
        """Create an instance of MergeUsersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MergeUsersResponse.parse_obj(obj)

        _obj = MergeUsersResponse.parse_obj({
