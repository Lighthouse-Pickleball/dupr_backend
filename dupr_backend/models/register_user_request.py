...
class RegisterUserRequest(BaseModel):
    ...
    __properties = ["isClubMember", "userId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegisterUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegisterUserRequest:
        """Create an instance of RegisterUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegisterUserRequest.parse_obj(obj)

        _obj = RegisterUserRequest.parse_obj({
