...
class PageOfOpenPlayMember(BaseModel):
    """
    ...
    hits: Optional[conlist(OpenPlayMember)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfOpenPlayMember:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfOpenPlayMember:
        """Create an instance of PageOfOpenPlayMember from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfOpenPlayMember.parse_obj(obj)

        _obj = PageOfOpenPlayMember.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [OpenPlayMember.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
