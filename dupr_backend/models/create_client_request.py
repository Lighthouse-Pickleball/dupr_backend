...
class CreateClientRequest(BaseModel):
    ...
    email: StrictStr
    name: StrictStr
    permissions: Optional[List[Permission]] = Field(default=None, description="An optional list of permissions to assign to the client key")
    __properties: ClassVar[List[str]] = ["email", "name", "permissions"]
