...
class UserMatchesRequest(BaseModel):
    ...
    __properties = ["bracketId", "clubId", "leagueMatchId", "limit", "offset"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserMatchesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserMatchesRequest:
        """Create an instance of UserMatchesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserMatchesRequest.parse_obj(obj)

        _obj = UserMatchesRequest.parse_obj({
