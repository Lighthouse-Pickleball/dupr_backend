...
class SingleWrapperOfRegistrationResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfRegistrationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfRegistrationResponse:
        """Create an instance of SingleWrapperOfRegistrationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfRegistrationResponse.parse_obj(obj)

        _obj = SingleWrapperOfRegistrationResponse.parse_obj({
            "message": obj.get("message"),
            "result": RegistrationResponse.from_dict(obj.get("result")) if obj.get("result") is not None else None,
