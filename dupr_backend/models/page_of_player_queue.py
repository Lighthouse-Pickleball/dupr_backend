...
class PageOfPlayerQueue(BaseModel):
    """
    PageOfPlayerQueue
    """
    ...
    hits: Optional[conlist(PlayerQueue)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfPlayerQueue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfPlayerQueue:
        """Create an instance of PageOfPlayerQueue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfPlayerQueue.parse_obj(obj)

        _obj = PageOfPlayerQueue.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [PlayerQueue.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
