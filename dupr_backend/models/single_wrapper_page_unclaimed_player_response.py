...
class SingleWrapperPageUnclaimedPlayerResponse(BaseModel):
    """
    SingleWrapperPageUnclaimedPlayerResponse
    """ # noqa: E501
    status: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    result: Optional[PageUnclaimedPlayerResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": PageUnclaimedPlayerResponse.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
