...
class PostMatchRating(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostMatchRating:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostMatchRating:
        """Create an instance of PostMatchRating from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostMatchRating.parse_obj(obj)

        _obj = PostMatchRating.parse_obj({
