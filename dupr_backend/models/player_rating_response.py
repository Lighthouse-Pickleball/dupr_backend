...
class PlayerRatingResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["singles", "singlesVerified", "singlesProvisional", "singlesReliabilityScore", "doubles", "doublesVerified", "doublesProvisional", "doublesReliabilityScore", "defaultRating", "provisionalRatings"]
