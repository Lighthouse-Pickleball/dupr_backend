...
class EditScoreRequest(BaseModel):
    ...
    __properties = ["game1", "game2", "game3", "game4", "game5", "teamId", "winner"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EditScoreRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EditScoreRequest:
        """Create an instance of EditScoreRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EditScoreRequest.parse_obj(obj)

        _obj = EditScoreRequest.parse_obj({
            "game1": obj.get("game1"),
            "game2": obj.get("game2"),
            "game3": obj.get("game3"),
            "game4": obj.get("game4"),
