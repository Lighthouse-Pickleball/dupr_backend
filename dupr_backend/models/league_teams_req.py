...
class LeagueTeamsReq(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "player1": PlayerReq.from_dict(obj["player1"]) if obj.get("player1") is not None else None,
            "player2": PlayerReq.from_dict(obj["player2"]) if obj.get("player2") is not None else None,
