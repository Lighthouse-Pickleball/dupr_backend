...
class SingleWrapperOfstring(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfstring:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfstring:
        """Create an instance of SingleWrapperOfstring from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfstring.parse_obj(obj)

        _obj = SingleWrapperOfstring.parse_obj({
