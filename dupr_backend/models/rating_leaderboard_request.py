...
class RatingLeaderboardRequest(BaseModel):
    """
    RatingLeaderboardRequest
    """ # noqa: E501
    min_player_age: StrictInt = Field(alias="minPlayerAge")
    max_player_age: StrictInt = Field(alias="maxPlayerAge")
    rating_type: StrictStr = Field(alias="ratingType")
    gender: StrictStr
    country: StrictStr
    state: StrictStr
    limit: StrictInt
    __properties: ClassVar[List[str]] = ["minPlayerAge", "maxPlayerAge", "ratingType", "gender", "country", "state", "limit"]

    @field_validator('rating_type')
    def rating_type_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minPlayerAge": obj.get("minPlayerAge"),
            "maxPlayerAge": obj.get("maxPlayerAge"),
