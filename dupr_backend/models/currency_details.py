...
class CurrencyDetails(BaseModel):
    ...
    currency_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="currencyRate")
    __properties: ClassVar[List[str]] = ["currencyCode", "currencySymbol", "currencyName", "currencyRate"]
