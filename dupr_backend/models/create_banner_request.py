...
class CreateBannerRequest(BaseModel):
    ...
    status: StrictStr
    title: StrictStr
    __properties: ClassVar[List[str]] = ["bannerId", "contentId", "description", "endDateTime", "startDateTime", "status", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "description": BannerContent.from_dict(obj["description"]) if obj.get("description") is not None else None,
