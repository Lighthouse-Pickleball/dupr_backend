...
class UserSubscription(BaseModel):
    ...
    __properties = ["billingPeriod", "cost", "duprId", "isActive", "renewalDate", "startDate", "userId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserSubscription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserSubscription:
        """Create an instance of UserSubscription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserSubscription.parse_obj(obj)

        _obj = UserSubscription.parse_obj({
