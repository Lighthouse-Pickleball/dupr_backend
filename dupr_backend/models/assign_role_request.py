...
class AssignRoleRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssignRoleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssignRoleRequest:
        """Create an instance of AssignRoleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssignRoleRequest.parse_obj(obj)

        _obj = AssignRoleRequest.parse_obj({
