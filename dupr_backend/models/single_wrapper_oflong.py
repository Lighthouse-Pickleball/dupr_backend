...
class SingleWrapperOflong(BaseModel):
    """
    SingleWrapperOflong
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOflong:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOflong:
        """Create an instance of SingleWrapperOflong from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOflong.parse_obj(obj)

        _obj = SingleWrapperOflong.parse_obj({
