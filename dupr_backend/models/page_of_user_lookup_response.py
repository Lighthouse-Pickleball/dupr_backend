...
class PageOfUserLookupResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(UserLookupResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfUserLookupResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfUserLookupResponse:
        """Create an instance of PageOfUserLookupResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfUserLookupResponse.parse_obj(obj)

        _obj = PageOfUserLookupResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [UserLookupResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
