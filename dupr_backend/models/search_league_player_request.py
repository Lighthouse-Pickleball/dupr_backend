...
class SearchLeaguePlayerRequest(BaseModel):
    """
    ...
    __properties = ["bracketId", "filters", "leagueId", "query", "sort"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchLeaguePlayerRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchLeaguePlayerRequest:
        """Create an instance of SearchLeaguePlayerRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchLeaguePlayerRequest.parse_obj(obj)

        _obj = SearchLeaguePlayerRequest.parse_obj({
            ...
            "query": obj.get("query"),
            "sort": PlayerSort.from_dict(obj.get("sort")) if obj.get("sort") is not None else None
        })
        return _obj
