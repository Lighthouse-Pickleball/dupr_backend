...
class MatchRatingSimulatorRequest(BaseModel):
    ...
    team1: TeamInfo
    team2: TeamInfo
    __properties: ClassVar[List[str]] = ["match", "team1", "team2"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "match": MatchInfo.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "team1": TeamInfo.from_dict(obj["team1"]) if obj.get("team1") is not None else None,
            "team2": TeamInfo.from_dict(obj["team2"]) if obj.get("team2") is not None else None
        })
        return _obj
