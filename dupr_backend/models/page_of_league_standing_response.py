...
class PageOfLeagueStandingResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(LeagueStandingResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfLeagueStandingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfLeagueStandingResponse:
        """Create an instance of PageOfLeagueStandingResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfLeagueStandingResponse.parse_obj(obj)

        _obj = PageOfLeagueStandingResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [LeagueStandingResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
