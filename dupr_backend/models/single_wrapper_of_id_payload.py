...
class SingleWrapperOfIdPayload(BaseModel):
    """
    SingleWrapperOfIdPayload
    """
    message: Optional[StrictStr] = None
    result: Optional[IdPayload] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfIdPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfIdPayload:
        """Create an instance of SingleWrapperOfIdPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfIdPayload.parse_obj(obj)

        _obj = SingleWrapperOfIdPayload.parse_obj({
            "message": obj.get("message"),
            "result": IdPayload.from_dict(obj.get("result")) if obj.get("result") is not None else None,
