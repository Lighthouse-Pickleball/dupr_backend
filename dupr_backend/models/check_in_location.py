...
class CheckInLocation(BaseModel):
    ...
    type: StrictStr
    id: StrictInt
    is_empty: StrictBool = Field(alias="isEmpty")
    __properties: ClassVar[List[str]] = ["address", "type", "id", "isEmpty"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CLUB', 'EVENT', 'RAW', 'NONE']):
            raise ValueError("must be one of enum values ('CLUB', 'EVENT', 'RAW', 'NONE')")
        return value
