...
class ArrayWrapperOfReaction(BaseModel):
    """
    ArrayWrapperOfReaction
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(Reaction)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfReaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfReaction:
        """Create an instance of ArrayWrapperOfReaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfReaction.parse_obj(obj)

        _obj = ArrayWrapperOfReaction.parse_obj({
            "message": obj.get("message"),
            "results": [Reaction.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
