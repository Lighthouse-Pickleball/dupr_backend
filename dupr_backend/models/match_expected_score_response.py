...
class MatchExpectedScoreResponse(BaseModel):
    """
    MatchExpectedScoreResponse
    """ # noqa: E501
    teams: List[TeamsResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [TeamsResponse.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
