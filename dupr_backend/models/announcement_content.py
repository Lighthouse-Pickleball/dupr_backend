...
class AnnouncementContent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnouncementContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnouncementContent:
        """Create an instance of AnnouncementContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnouncementContent.parse_obj(obj)

        _obj = AnnouncementContent.parse_obj({
