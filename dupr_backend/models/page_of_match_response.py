...
class PageOfMatchResponse(BaseModel):
    """
    PageOfMatchResponse
    """
    ...
    hits: Optional[conlist(MatchResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfMatchResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfMatchResponse:
        """Create an instance of PageOfMatchResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfMatchResponse.parse_obj(obj)

        _obj = PageOfMatchResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [MatchResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
