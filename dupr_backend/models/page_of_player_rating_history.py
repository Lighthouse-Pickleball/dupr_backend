...
class PageOfPlayerRatingHistory(BaseModel):
    """
    ...
    hits: Optional[conlist(PlayerRatingHistory)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfPlayerRatingHistory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfPlayerRatingHistory:
        """Create an instance of PageOfPlayerRatingHistory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfPlayerRatingHistory.parse_obj(obj)

        _obj = PageOfPlayerRatingHistory.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [PlayerRatingHistory.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
