...
class ArrayWrapperScoreFormatResponse(BaseModel):
    """
    ArrayWrapperScoreFormatResponse
    """ # noqa: E501
    status: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    results: Optional[List[ScoreFormatResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ScoreFormatResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
