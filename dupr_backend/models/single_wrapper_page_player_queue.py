...
class SingleWrapperPagePlayerQueue(BaseModel):
    """
    SingleWrapperPagePlayerQueue
    """ # noqa: E501
    status: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    result: Optional[PagePlayerQueue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": PagePlayerQueue.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
