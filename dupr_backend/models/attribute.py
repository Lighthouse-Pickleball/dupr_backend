...
class Attribute(BaseModel):
    ...
    Attribute
    """ # noqa: E501
    children: Optional[Dict[str, Attribute]] = Field(default=None, alias="_children")
    comment: StrictStr = Field(alias="_comment")
    value: StrictStr
    __properties: ClassVar[List[str]] = ["_children", "_comment", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_children": dict(
                ...
                for _k, _v in obj["_children"].items()
            )
            if obj.get("_children") is not None
            else None,
            "_comment": obj.get("_comment"),
            "value": obj.get("value")
        })
        return _obj
