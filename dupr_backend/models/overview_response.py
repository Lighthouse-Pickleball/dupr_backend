...
class OverviewResponse(BaseModel):
    ...
    __properties = ["all", "losses", "pending", "wins"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OverviewResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OverviewResponse:
        """Create an instance of OverviewResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OverviewResponse.parse_obj(obj)

        _obj = OverviewResponse.parse_obj({
            "all": obj.get("all"),
