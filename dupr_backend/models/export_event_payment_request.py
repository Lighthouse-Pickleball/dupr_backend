...
class ExportEventPaymentRequest(BaseModel):
    """
    ...
    __properties = ["bracketId", "clubId", "leagueId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportEventPaymentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportEventPaymentRequest:
        """Create an instance of ExportEventPaymentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportEventPaymentRequest.parse_obj(obj)

        _obj = ExportEventPaymentRequest.parse_obj({
