...
class ArrayWrapperOfGeocodingResult(BaseModel):
    """
    ArrayWrapperOfGeocodingResult
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(GeocodingResult)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfGeocodingResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfGeocodingResult:
        """Create an instance of ArrayWrapperOfGeocodingResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfGeocodingResult.parse_obj(obj)

        _obj = ArrayWrapperOfGeocodingResult.parse_obj({
            "message": obj.get("message"),
            "results": [GeocodingResult.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
