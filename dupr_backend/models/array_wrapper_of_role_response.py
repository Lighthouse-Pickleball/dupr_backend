...
class ArrayWrapperOfRoleResponse(BaseModel):
    """
    ArrayWrapperOfRoleResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(RoleResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfRoleResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfRoleResponse:
        """Create an instance of ArrayWrapperOfRoleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfRoleResponse.parse_obj(obj)

        _obj = ArrayWrapperOfRoleResponse.parse_obj({
            "message": obj.get("message"),
            "results": [RoleResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
