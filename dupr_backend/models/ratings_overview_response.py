...
class RatingsOverviewResponse(BaseModel):
    ...
    __properties = ["losses", "pending", "wins"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RatingsOverviewResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RatingsOverviewResponse:
        """Create an instance of RatingsOverviewResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RatingsOverviewResponse.parse_obj(obj)

        _obj = RatingsOverviewResponse.parse_obj({
