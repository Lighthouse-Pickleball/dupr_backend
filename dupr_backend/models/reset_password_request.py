...
class ResetPasswordRequest(BaseModel):
    ...
    """ # noqa: E501
    old_password: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="oldPassword")
    new_password: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="newPassword")
