...
class MiLPEventRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addressId", "clubId", "defaultEntryFee", "defaultMaxTeams", "defaultMaxWaitlist", "description", "divisions", "duration", "eventName", "eventType", "organizers", "status", "timeZone"]
