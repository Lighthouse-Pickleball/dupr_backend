...
class MatchRound(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["serial", "matches", "startDate", "endDate", "teamIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matches": [SeedMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
