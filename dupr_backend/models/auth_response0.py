...
class AuthResponse0(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthResponse0:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthResponse0:
        """Create an instance of AuthResponse0 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthResponse0.parse_obj(obj)

        _obj = AuthResponse0.parse_obj({
