...
class RegisterToBracketRequest(BaseModel):
    ...
    users: Optional[List[RegisterUserRequest]] = None
    __properties: ClassVar[List[str]] = ["bracketId", "clubId", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [RegisterUserRequest.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
