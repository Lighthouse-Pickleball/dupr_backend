...
class ArrayWrapperOfstring(BaseModel):
    """
    ArrayWrapperOfstring
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(StrictStr)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfstring:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfstring:
        """Create an instance of ArrayWrapperOfstring from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfstring.parse_obj(obj)

        _obj = ArrayWrapperOfstring.parse_obj({
