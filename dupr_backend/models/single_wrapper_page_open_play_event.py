...
class SingleWrapperPageOpenPlayEvent(BaseModel):
    """
    SingleWrapperPageOpenPlayEvent
    """ # noqa: E501
    status: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    result: Optional[PageOpenPlayEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": PageOpenPlayEvent.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
