...
class PageOfClubMemberResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(ClubMemberResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfClubMemberResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfClubMemberResponse:
        """Create an instance of PageOfClubMemberResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfClubMemberResponse.parse_obj(obj)

        _obj = PageOfClubMemberResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [ClubMemberResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
