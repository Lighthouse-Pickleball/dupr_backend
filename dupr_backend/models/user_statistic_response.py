...
class UserStatisticResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["overview", "trends"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overview": RatingOverviewResponse.from_dict(obj["overview"]) if obj.get("overview") is not None else None,
            "trends": TrendResponse.from_dict(obj["trends"]) if obj.get("trends") is not None else None
        })
        return _obj
