...
class PromotionCampaignRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    client_key_id: StrictInt = Field(alias="clientKeyId")
    criteria: List[CriteriaDefinition]
    product_ids: List[StrictStr] = Field(alias="productIds")
    __properties: ClassVar[List[str]] = ["name", "clientKeyId", "criteria", "productIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "clientKeyId": obj.get("clientKeyId"),
            "criteria": [CriteriaDefinition.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None,
