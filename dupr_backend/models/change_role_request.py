...
class ChangeRoleRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChangeRoleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChangeRoleRequest:
        """Create an instance of ChangeRoleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChangeRoleRequest.parse_obj(obj)

        _obj = ChangeRoleRequest.parse_obj({
            "role": obj.get("role"),
