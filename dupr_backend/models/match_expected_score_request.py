...
class MatchExpectedScoreRequest(BaseModel):
    """
    ...
    game_count: StrictInt = Field(alias="gameCount")
    winning_score: StrictInt = Field(alias="winningScore")
    match_type: StrictStr = Field(alias="matchType")
    __properties: ClassVar[List[str]] = ["teams", "eventFormat", "matchSource", "gameCount", "winningScore", "matchType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [TeamIds.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None,
