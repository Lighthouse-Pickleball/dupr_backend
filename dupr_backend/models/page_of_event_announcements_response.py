...
class PageOfEventAnnouncementsResponse(BaseModel):
    ...
    hits: Optional[List[EventAnnouncementsResponse]] = Field(default=None, description="Array of results, can be empty.")
    ...
    __properties: ClassVar[List[str]] = ["empty", "hasMore", "hasPrevious", "hits", "limit", "offset", "total", "totalValueRelation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hits": [EventAnnouncementsResponse.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
