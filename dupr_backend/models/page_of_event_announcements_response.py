...
class PageOfEventAnnouncementsResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(EventAnnouncementsResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfEventAnnouncementsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfEventAnnouncementsResponse:
        """Create an instance of PageOfEventAnnouncementsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfEventAnnouncementsResponse.parse_obj(obj)

        _obj = PageOfEventAnnouncementsResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [EventAnnouncementsResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
