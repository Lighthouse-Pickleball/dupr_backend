...
class SeedMatchReq(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeedMatchReq:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeedMatchReq:
        """Create an instance of SeedMatchReq from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeedMatchReq.parse_obj(obj)

        _obj = SeedMatchReq.parse_obj({
            "bye": obj.get("bye"),
            "match_serial": obj.get("matchSerial"),
            "serial": obj.get("serial"),
            "team1": LeagueTeamsReq.from_dict(obj.get("team1")) if obj.get("team1") is not None else None,
            "team2": LeagueTeamsReq.from_dict(obj.get("team2")) if obj.get("team2") is not None else None
        })
        return _obj
