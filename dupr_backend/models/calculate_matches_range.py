...
class CalculateMatchesRange(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalculateMatchesRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalculateMatchesRange:
        """Create an instance of CalculateMatchesRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalculateMatchesRange.parse_obj(obj)

        _obj = CalculateMatchesRange.parse_obj({
