...
class UpdateClientPermissionsRequest(BaseModel):
    ...
    permissions: List[Permission] = Field(description="An optional list of permissions to assign to the client key")
    __properties: ClassVar[List[str]] = ["clientId", "keyId", "permissions"]
