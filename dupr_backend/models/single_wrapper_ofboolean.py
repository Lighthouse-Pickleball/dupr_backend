...
class SingleWrapperOfboolean(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfboolean:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfboolean:
        """Create an instance of SingleWrapperOfboolean from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfboolean.parse_obj(obj)

        _obj = SingleWrapperOfboolean.parse_obj({
