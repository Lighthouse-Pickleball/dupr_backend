...
class UserStatusUpdateRequest(BaseModel):
    ...
    __properties = ["notes", "status", "userId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserStatusUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserStatusUpdateRequest:
        """Create an instance of UserStatusUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserStatusUpdateRequest.parse_obj(obj)

        _obj = UserStatusUpdateRequest.parse_obj({
            "notes": obj.get("notes"),
