...
class ExternalFilterLocation(BaseModel):
    ...
    """ # noqa: E501
    lat: Union[Annotated[float, Field(le=90, strict=True, ge=-90)], Annotated[int, Field(le=90, strict=True, ge=-90)]] = Field(description="Earth's latitude value")
    lng: Union[Annotated[float, Field(le=180, strict=True, ge=-180)], Annotated[int, Field(le=180, strict=True, ge=-180)]] = Field(description="Earth's longitude value")
    ...
    __properties: ClassVar[List[str]] = ["lat", "lng", "address", "radiusInMeters"]
