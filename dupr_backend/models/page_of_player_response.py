...
class PageOfPlayerResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(PlayerResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfPlayerResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfPlayerResponse:
        """Create an instance of PageOfPlayerResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfPlayerResponse.parse_obj(obj)

        _obj = PageOfPlayerResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [PlayerResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
