...
class ArrayWrapperOfClubListingResponse(BaseModel):
    """
    ArrayWrapperOfClubListingResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(ClubListingResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfClubListingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfClubListingResponse:
        """Create an instance of ArrayWrapperOfClubListingResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfClubListingResponse.parse_obj(obj)

        _obj = ArrayWrapperOfClubListingResponse.parse_obj({
            "message": obj.get("message"),
            "results": [ClubListingResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
