...
class PageOfClubResponse(BaseModel):
    """
    PageOfClubResponse
    """
    ...
    hits: Optional[conlist(ClubResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfClubResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfClubResponse:
        """Create an instance of PageOfClubResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfClubResponse.parse_obj(obj)

        _obj = PageOfClubResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [ClubResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
