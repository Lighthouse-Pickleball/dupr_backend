...
class AnnouncementHistoryRequest(BaseModel):
    """
    ...
    __properties = ["bracketId", "clubId", "leagueId", "limit", "offset"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnouncementHistoryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnouncementHistoryRequest:
        """Create an instance of AnnouncementHistoryRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnouncementHistoryRequest.parse_obj(obj)

        _obj = AnnouncementHistoryRequest.parse_obj({
