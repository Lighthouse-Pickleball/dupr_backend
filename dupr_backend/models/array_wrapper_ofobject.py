...
class ArrayWrapperOfobject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfobject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfobject:
        """Create an instance of ArrayWrapperOfobject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfobject.parse_obj(obj)

        _obj = ArrayWrapperOfobject.parse_obj({
