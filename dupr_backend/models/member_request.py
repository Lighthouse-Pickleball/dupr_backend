...
class MemberRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MemberRequest:
        """Create an instance of MemberRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberRequest.parse_obj(obj)

        _obj = MemberRequest.parse_obj({
            "email": obj.get("email"),
