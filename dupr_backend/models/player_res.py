...
class PlayerRes(BaseModel):
    ...
    sponsor: Optional[SponsorRes] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlayerRes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlayerRes:
        """Create an instance of PlayerRes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlayerRes.parse_obj(obj)

        _obj = PlayerRes.parse_obj({
            "age": obj.get("age"),
            ...
            "sponsor": SponsorRes.from_dict(obj.get("sponsor")) if obj.get("sponsor") is not None else None,
