...
class AgeFilter(BaseModel):
    ...
    min_age: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, alias="minAge")
    __properties: ClassVar[List[str]] = ["maxAge", "minAge"]
