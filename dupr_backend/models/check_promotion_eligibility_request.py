...
class CheckPromotionEligibilityRequest(BaseModel):
    """
    CheckPromotionEligibilityRequest
    """ # noqa: E501
    base64_client_key: StrictStr = Field(alias="base64ClientKey")
    promotion_id: StrictStr = Field(alias="promotionId")
    __properties: ClassVar[List[str]] = ["base64ClientKey", "promotionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base64ClientKey": obj.get("base64ClientKey"),
