...
class ConfirmTeamRequest(BaseModel):
    ...
    __properties = ["bracketId", "registrationId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfirmTeamRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfirmTeamRequest:
        """Create an instance of ConfirmTeamRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfirmTeamRequest.parse_obj(obj)

        _obj = ConfirmTeamRequest.parse_obj({
