...
class ArrayWrapperOfScoreFormatResponse(BaseModel):
    """
    ArrayWrapperOfScoreFormatResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(ScoreFormatResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfScoreFormatResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfScoreFormatResponse:
        """Create an instance of ArrayWrapperOfScoreFormatResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfScoreFormatResponse.parse_obj(obj)

        _obj = ArrayWrapperOfScoreFormatResponse.parse_obj({
            "message": obj.get("message"),
            "results": [ScoreFormatResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
