...
class PageOfLeagueMatchResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(LeagueMatchResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfLeagueMatchResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfLeagueMatchResponse:
        """Create an instance of PageOfLeagueMatchResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfLeagueMatchResponse.parse_obj(obj)

        _obj = PageOfLeagueMatchResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [LeagueMatchResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
