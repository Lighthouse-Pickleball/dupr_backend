...
class ArrayWrapperOfLeagueTeamsResponse(BaseModel):
    """
    ArrayWrapperOfLeagueTeamsResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(LeagueTeamsResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfLeagueTeamsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfLeagueTeamsResponse:
        """Create an instance of ArrayWrapperOfLeagueTeamsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfLeagueTeamsResponse.parse_obj(obj)

        _obj = ArrayWrapperOfLeagueTeamsResponse.parse_obj({
            "message": obj.get("message"),
            "results": [LeagueTeamsResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
