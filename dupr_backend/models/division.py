...
class Division(BaseModel):
    ...
    registration_start: Optional[date] = Field(default=None, alias="registrationStart")
    registration_end: Optional[date] = Field(default=None, alias="registrationEnd")
    day1_start: Optional[date] = Field(default=None, alias="day1Start")
    day2_start: Optional[date] = Field(default=None, alias="day2Start")
    ...
    __properties: ClassVar[List[str]] = ["eventId", "divisionId", "divisionName", "divisionCode", "registrationPeriod", "registrationStart", "registrationEnd", "day1Start", "day2Start", "maxTeams", "maxWaitlist", "entryFee", "prize", "divisionType", "status"]
