...
class UserSearchRequest(BaseModel):
    ...
    search_field: Optional[StrictStr] = Field(default=None, alias="searchField")
    __properties: ClassVar[List[str]] = ["offset", "limit", "query", "searchField"]
    ...
    def search_field_validate_enum(cls, value):
        ...
        if value not in set(['FULLNAME', 'EMAIL', 'DUPR_ID', 'PHONE']):
            raise ValueError("must be one of enum values ('FULLNAME', 'EMAIL', 'DUPR_ID', 'PHONE')")
        return value
