...
class SingleWrapperOfArrayOfAutocompletePrediction(BaseModel):
    ...
    result: Optional[List[AutocompletePrediction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [AutocompletePrediction.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
