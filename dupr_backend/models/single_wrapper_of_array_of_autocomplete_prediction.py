...
class SingleWrapperOfArrayOfAutocompletePrediction(BaseModel):
    """
    SingleWrapperOfArrayOfAutocompletePrediction
    """
    message: Optional[StrictStr] = None
    result: Optional[conlist(AutocompletePrediction)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfArrayOfAutocompletePrediction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfArrayOfAutocompletePrediction:
        """Create an instance of SingleWrapperOfArrayOfAutocompletePrediction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfArrayOfAutocompletePrediction.parse_obj(obj)

        _obj = SingleWrapperOfArrayOfAutocompletePrediction.parse_obj({
            "message": obj.get("message"),
            "result": [AutocompletePrediction.from_dict(_item) for _item in obj.get("result")] if obj.get("result") is not None else None,
