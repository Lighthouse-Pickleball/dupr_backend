...
class PageOfBracketResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(BracketResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfBracketResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfBracketResponse:
        """Create an instance of PageOfBracketResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfBracketResponse.parse_obj(obj)

        _obj = PageOfBracketResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [BracketResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
