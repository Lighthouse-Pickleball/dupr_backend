...
class SingleWrapperOfMapOfstringAndobject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfMapOfstringAndobject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfMapOfstringAndobject:
        """Create an instance of SingleWrapperOfMapOfstringAndobject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfMapOfstringAndobject.parse_obj(obj)

        _obj = SingleWrapperOfMapOfstringAndobject.parse_obj({
