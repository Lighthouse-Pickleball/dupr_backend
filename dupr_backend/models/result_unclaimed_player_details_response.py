...
class ResultUnclaimedPlayerDetailsResponse(BaseModel):
    """
    ResultUnclaimedPlayerDetailsResponse
    """ # noqa: E501
    status: StrictStr
    results: List[UnclaimedPlayerDetailsResponse]
    errors: List[Error]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [UnclaimedPlayerDetailsResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
