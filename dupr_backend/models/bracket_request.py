...
class BracketRequest(BaseModel):
    ...
    duration: List[date]
    format: StrictStr
    elimination: StrictStr
    player_group: StrictStr = Field(alias="playerGroup")
    ...
    __properties: ClassVar[List[str]] = ["customCode", "duration", "format", "elimination", "playerGroup", "ratingBracket", "ageBracket", "description", "matchBonusPoints", "registrationDate", "scoreFormat", "memberFee", "nonMemberFee", "maxTeam", "waitList", "leagueId", "bracketId", "name", "courts", "registrationDateTime", "durationDateTime", "timeZone", "zoneName"]
