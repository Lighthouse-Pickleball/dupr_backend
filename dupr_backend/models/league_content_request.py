...
class LeagueContentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeagueContentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeagueContentRequest:
        """Create an instance of LeagueContentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeagueContentRequest.parse_obj(obj)

        _obj = LeagueContentRequest.parse_obj({
