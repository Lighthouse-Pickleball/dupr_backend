...
class ClubMemberAddRequest(BaseModel):
    ...
    """ # noqa: E501
    add_members: List[MemberRequest] = Field(alias="addMembers")
    __properties: ClassVar[List[str]] = ["addMembers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addMembers": [MemberRequest.from_dict(_item) for _item in obj["addMembers"]] if obj.get("addMembers") is not None else None
        })
        return _obj
