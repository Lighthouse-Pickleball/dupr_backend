...
class EditBracketRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ageBracket", "bracketId", "courts", "customCode", "description", "duration", "durationDateTime", "elimination", "format", "leagueId", "matchBonusPoints", "maxTeam", "memberFee", "name", "nonMemberFee", "playerGroup", "ratingBracket", "registrationDate", "registrationDateTime", "scoreFormat", "status", "timeZone", "waitList", "zoneName"]
