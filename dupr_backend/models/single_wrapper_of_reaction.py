...
class SingleWrapperOfReaction(BaseModel):
    """
    SingleWrapperOfReaction
    """
    message: Optional[StrictStr] = None
    result: Optional[Reaction] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfReaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfReaction:
        """Create an instance of SingleWrapperOfReaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfReaction.parse_obj(obj)

        _obj = SingleWrapperOfReaction.parse_obj({
            "message": obj.get("message"),
            "result": Reaction.from_dict(obj.get("result")) if obj.get("result") is not None else None,
