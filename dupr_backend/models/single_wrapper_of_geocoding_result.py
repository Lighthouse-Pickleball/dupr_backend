...
class SingleWrapperOfGeocodingResult(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleWrapperOfGeocodingResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleWrapperOfGeocodingResult:
        """Create an instance of SingleWrapperOfGeocodingResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleWrapperOfGeocodingResult.parse_obj(obj)

        _obj = SingleWrapperOfGeocodingResult.parse_obj({
            "message": obj.get("message"),
            "result": GeocodingResult.from_dict(obj.get("result")) if obj.get("result") is not None else None,
