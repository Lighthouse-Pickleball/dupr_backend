...
class UpdateRegistrationRequest(BaseModel):
    ...
    registration_status: StrictStr = Field(alias="registrationStatus")
    ...
    __properties: ClassVar[List[str]] = ["userId", "bracketId", "leagueId", "paymentStatus", "registrationStatus", "bracketFeesPaid", "eventFeesPaid", "isRegistered"]
