...
class SubscriptionResponse(BaseModel):
    ...
    """ # noqa: E501
    subscriptions: List[Subscription] = Field(description="A list of subscription descriptors. Descriptors will contain a list of operations and entitlements, which can be used to gate 3rd party features")
