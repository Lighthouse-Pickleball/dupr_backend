...
class PageOfOpenPlayEvent(BaseModel):
    """
    PageOfOpenPlayEvent
    """
    ...
    hits: Optional[conlist(OpenPlayEvent)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfOpenPlayEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfOpenPlayEvent:
        """Create an instance of PageOfOpenPlayEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfOpenPlayEvent.parse_obj(obj)

        _obj = PageOfOpenPlayEvent.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [OpenPlayEvent.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
