...
class PageOfPlayerPaymentResponse(BaseModel):
    """
    ...
    hits: Optional[conlist(PlayerPaymentResponse)] = Field(None, description="Array of results, can be empty.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageOfPlayerPaymentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageOfPlayerPaymentResponse:
        """Create an instance of PageOfPlayerPaymentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageOfPlayerPaymentResponse.parse_obj(obj)

        _obj = PageOfPlayerPaymentResponse.parse_obj({
            "empty": obj.get("empty"),
            "has_more": obj.get("hasMore"),
            "has_previous": obj.get("hasPrevious"),
            "hits": [PlayerPaymentResponse.from_dict(_item) for _item in obj.get("hits")] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
