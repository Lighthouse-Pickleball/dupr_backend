...
class PageOfPlayerPaymentResponse(BaseModel):
    ...
    hits: Optional[List[PlayerPaymentResponse]] = Field(default=None, description="Array of results, can be empty.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hits": [PlayerPaymentResponse.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None,
            "limit": obj.get("limit"),
