...
class ArrayWrapperOflong(BaseModel):
    """
    ArrayWrapperOflong
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(StrictInt)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOflong:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOflong:
        """Create an instance of ArrayWrapperOflong from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOflong.parse_obj(obj)

        _obj = ArrayWrapperOflong.parse_obj({
