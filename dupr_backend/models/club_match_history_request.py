...
class ClubMatchHistoryRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clubId", "filters", "limit", "offset", "sort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": ClubMatchFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "sort": ClubMatchSort.from_dict(obj["sort"]) if obj.get("sort") is not None else None
        })
        return _obj
