...
class SponsorRes(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SponsorRes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SponsorRes:
        """Create an instance of SponsorRes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SponsorRes.parse_obj(obj)

        _obj = SponsorRes.parse_obj({
