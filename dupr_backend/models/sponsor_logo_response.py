...
class SponsorLogoResponse(BaseModel):
    ...
    __properties = ["buttonText", "description", "imageURL", "sponsorPopupHeading", "sponsorRedirectUrl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SponsorLogoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SponsorLogoResponse:
        """Create an instance of SponsorLogoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SponsorLogoResponse.parse_obj(obj)

        _obj = SponsorLogoResponse.parse_obj({
