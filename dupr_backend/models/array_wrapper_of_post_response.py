...
class ArrayWrapperOfPostResponse(BaseModel):
    """
    ArrayWrapperOfPostResponse
    """
    message: Optional[StrictStr] = None
    results: Optional[conlist(PostResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayWrapperOfPostResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayWrapperOfPostResponse:
        """Create an instance of ArrayWrapperOfPostResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayWrapperOfPostResponse.parse_obj(obj)

        _obj = ArrayWrapperOfPostResponse.parse_obj({
            "message": obj.get("message"),
            "results": [PostResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
