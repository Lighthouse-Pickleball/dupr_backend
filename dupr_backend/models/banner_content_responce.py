...
class BannerContentResponce(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BannerContentResponce:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BannerContentResponce:
        """Create an instance of BannerContentResponce from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BannerContentResponce.parse_obj(obj)

        _obj = BannerContentResponce.parse_obj({
