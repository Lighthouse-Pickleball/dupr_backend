...
class AddressApi:
    ...
    def autocomplete(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SingleWrapperAutocompletePrediction",
        }
    ...
    def autocomplete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SingleWrapperAutocompletePrediction]:
        """autocomplete
    ...
    def delete_user_address(
        ...
        :param version: (required)
        :type version: str
        :param id_payload: (required)
        :type id_payload: IdPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_user_address_serialize(
            version=version,
    ...
    @validate_call
    def delete_user_address_with_http_info(
        self,
        version: StrictStr,
        id_payload: IdPayload,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_user_address_without_preload_content(
        self,
        version: StrictStr,
        id_payload: IdPayload,
        _request_timeout: Union[
    ...
    def _delete_user_address_serialize(
        self,
        version,
        id_payload,
        _request_auth,
    ...
    def geocode(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ArrayWrapperGeocodingResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def geocode_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ArrayWrapperGeocodingResult]:
        """geocode
    ...
    def place_details(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SingleWrapperGeocodingResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def place_details_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SingleWrapperGeocodingResult]:
        """place_details
    ...
    def save_address(
        ...
        :param version: (required)
        :type version: str
        :param address_request: (required)
        ...
        _param = self._save_address_serialize(
            version=version,
    ...
    @validate_call
    def save_address_with_http_info(
        self,
        version: StrictStr,
        address_request: AddressRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SingleWrapperIdPayload]:
        """save_address
    ...
    @validate_call
    def save_address_without_preload_content(
        self,
        version: StrictStr,
        address_request: AddressRequest,
        _request_timeout: Union[
