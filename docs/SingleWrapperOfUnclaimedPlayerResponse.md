...
single_wrapper_of_unclaimed_player_response_from_dict = SingleWrapperOfUnclaimedPlayerResponse.from_dict(single_wrapper_of_unclaimed_player_response_dict)
```
